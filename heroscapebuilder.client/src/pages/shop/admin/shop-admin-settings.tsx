...
import { ShopSettings } from '../../../models/shop';
import { adminGetSettings, adminSaveSettings, getErrorMessages } from '../../../services/shop-service';
            ...
            <Stack spacing={2}>
                ...
                {settings.stripeConfigured && !settings.webhookConfigured && (
                    <Alert severity="warning">
                        ...
                        but an order is missed if they close the tab first. Refunds made in the Stripe dashboard also won't show here.
                    </Alert>
                )}
